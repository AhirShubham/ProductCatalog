...
import com.shubham.springboot.productcatalog.Clients.FakeStoreApiClient;
...
public class FakeStoreProductService implements IProductService{
    ...
    public Product getProductById(Long id) {
        ...
        FakeStoreProductDto fakeStoreProductDtoResponseEntity = fakeStoreApiClient.getProductById(id);
    ...
    public List<Product> getAllProducts() {
        ...
        List<FakeStoreProductDto> response=fakeStoreApiClient.getProducts();

        return response.stream().map(this::getProduct).toList();
    ...
    public Product replaceProduct(Long id, Product product) {
        ...
        FakeStoreProductDto fakeStoreProductDtoResponse = fakeStoreApiClient.replaceProduct(id, fakeStoreProductDto);
